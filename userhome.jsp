      ...
      <div id="topbar" class="d-flex align-items-center fixed-top">
         <div class="container d-flex justify-content-between">
            <div class="contact-info d-flex align-items-center">
               <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">kmlshwadile@gmail.com</a>
               <i class="bi bi-phone"></i> +91 8959526326
            </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-4 d-flex align-items-stretch">
                     <div class="content">
                        <h3>Why Choose PharmaSage?</h3>
                        <p>
                           Welcome to PharmaSage, your ultimate destination for all your pharmacy needs. 
            ...
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                     <h3>Discover the Vision Behind PharmaSage: Empowering Your Health and Wellness Journey</h3>
                  ...
                  <div class="col-lg-4">
                     <div class="info">
                        <div class="address">
                           ...
                           <h4>Location:</h4>
                           <p>A108 Silicon, Indore</p>
                        </div>
                        <div class="email">
                           <i class="bi bi-envelope"></i>
                           <h4>Email:</h4>
                           <p>kmlshwadile@gmail.com</p>
                        </div>
                        <div class="phone">
      ...
      <footer id="footer">
               ...
               <div class="row">
                  <div class="col-lg-3 col-md-6 footer-contact">
                     ...
                     <p>
                        ...
                        Indore <br>
                        India<br><br>
                        <strong>Phone:</strong> +91 8959526326<br>
                        <strong>Email:</strong> Kmlshwadile@gmail.com<br>
                     </p>
                  </div>
         ...
         <div class="container d-md-flex py-4">
            <div class="me-md-auto text-center text-md-start">
               ...
               <div class="credits">
                  Designed by <a href="https://bootstrapmade.com/">Kamlesh</a>
               </div>
            </div>
